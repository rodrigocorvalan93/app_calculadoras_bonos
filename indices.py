...
if principales_variables_df is not None:
    pass
else:
...
if tamar_new_df is not None:
    pass
else:
    print("ERROR: No se pudieron obtener los datos de la variable TAMAR.")

# POMO:
idVariable = 6
pomo_new_df = fetch_variable_data_api_v3(idVariable, start_date, end_date)
if pomo_new_df is not None:
    pass
else:
    print("ERROR: No se pudieron obtener los datos de la variable POMO.")
